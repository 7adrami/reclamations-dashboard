...
TEXTS = {
    "fr": {
        ...
        "lookup_needed": "saisissez au moins un n° de téléphone, une date ou un montant",
        "lookup_none": "aucune correspondance trouvée dans la base",
        "lookup_db_error": "remplissage auto indisponible (base de données inaccessible)",
        "results": "Résultats",
    ...
    "ar": {
        ...
        "lookup_btn": "بحث",
        "lookup_needed": "أدخل على الأقل رقم هاتف أو تاريخ أو مبلغ",
        "lookup_none": "لا يوجد تطابق في قاعدة البيانات",
        "lookup_db_error": "التعبئة التلقائية غير متاحة (قاعدة البيانات غير متاحة)",
        "results": "النتائج",
